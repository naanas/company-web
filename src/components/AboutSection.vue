...
<template>
  <section id="about" ref="section" class="relative min-h-[130vh] bg-brand-950 px-6 py-32">
    <div class="mx-auto flex max-w-6xl flex-col gap-16 lg:sticky lg:top-32">
      <div data-reveal class="text-eyebrow max-w-xs text-white/50">
        Kami Merancang untuk Ketahanan Jangka Panjang.<br />
        Kejelasan Lebih Dulu, Kualitas Selalu, Dibangun untuk Skala.
      </div>

      <p ref="words" class="text-display max-w-5xl text-white/90">
      ...
      <div data-reveal class="ml-auto flex max-w-sm flex-col items-start gap-6 text-right sm:text-left">
        ...
        <a href="#services" class="group flex items-center gap-2 border-b border-white/30 pb-1 text-sm font-medium text-white/80 transition-colors hover:border-white hover:text-white">
