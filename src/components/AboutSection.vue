...
<template>
  <section id="about" ref="section" class="relative min-h-[130vh] overflow-hidden bg-paper-100">
    ...
    <div class="overflow-hidden border-y border-white/10 bg-brand-950 py-10">
    ...
    <div class="mx-auto flex max-w-6xl flex-col gap-16 px-6 pt-16 pb-32 lg:sticky lg:top-32">
